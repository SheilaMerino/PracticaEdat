...
public class ColeccionArray2DTest {
	...
	public void testMetodosNoImplementados_add() {
		...
		// Metodo que deberá lanzar la excepcion: el metodo añadir no deberá estar soportado
//		Executable metodo = () -> coleccionInteger.add(5);
...
//		assertThrows(UnsupportedOperationException.class, metodo);
	...
	*/
	...
	public void iteratorRemove() {
		...
		// y sin embargo se puede ejecutar, ya que estÃ¡ incluido en la implementacion de AbstractColletion
	...
	// public void metodoSet() {
		...
		// colecciónString = new ColecciónArray2D<String>(arrayString);
